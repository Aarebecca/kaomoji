...
export default class EmoticonLangLexer extends Lexer {
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(this, EmoticonLangLexer._ATN, EmoticonLangLexer.DecisionsToDFA, new PredictionContextCache());
	}

	public get grammarFileName(): string { return "kaomoji.g4"; }

	public get literalNames(): (string | null)[] { return EmoticonLangLexer.literalNames; }
	public get symbolicNames(): (string | null)[] { return EmoticonLangLexer.symbolicNames; }
	public get ruleNames(): string[] { return EmoticonLangLexer.ruleNames; }

	public get serializedATN(): number[] { return EmoticonLangLexer._serializedATN; }

	public get channelNames(): string[] { return EmoticonLangLexer.channelNames; }

	public get modeNames(): string[] { return EmoticonLangLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!EmoticonLangLexer.__ATN) {
			EmoticonLangLexer.__ATN = new ATNDeserializer().deserialize(EmoticonLangLexer._serializedATN);
		}

		return EmoticonLangLexer.__ATN;
	}


	static DecisionsToDFA = EmoticonLangLexer._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );
}